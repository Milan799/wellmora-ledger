...
export default function Filters({ 
  ...
  return (
    <div className="glass-panel rounded-xl p-4 mb-5 border border-slate-200 dark:border-slate-800/60 shadow-sm space-y-3 animate-fade-in">
      ...
      {setDateRange && (
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5 pt-2.5 border-t border-slate-200/60 dark:border-slate-800/60 text-xs">
