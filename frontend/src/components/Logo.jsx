...
export default function Logo({ size = 24, className = "", showBackground = true }) {
  return (
    <svg 
    ...
    >
      ...
      {showBackground && (
        <rect x="24" y="24" width="464" height="464" rx="96" fill="#0b0f19" stroke="#334155" strokeWidth="4" />
      )}

      {/* 4 Origami Faceted Wings of 'W' (No Dots) */}
      <g filter="url(#wm-origami-glow)">
        <path d="M 75 140 L 155 370 L 215 220 L 145 140 Z" fill="url(#wm-facet-1)" />
        <path d="M 215 220 L 155 370 L 256 270 Z" fill="url(#wm-facet-2)" opacity="0.9" />
        <path d="M 256 270 L 357 370 L 297 220 Z" fill="url(#wm-facet-3)" opacity="0.9" />
